    ...
    <aside className={`sidebar ${isOpen ? 'open' : ''}`}>
        ...
        <ul>
          {diseases.map((disease) => (
            <li key={disease} className={`nav-item ${disease === activeDisease ? 'active' : ''}`}>
              <a href="#" className="nav-link" onClick={handleLinkClick} title={isOpen ? '' : disease}>
      ...
      <div className="sidebar-footer">
        ...
        <div className="footer-links">
            <Link to="/" className="nav-link home-link" onClick={handleLinkClick} title={isOpen ? '' : 'Back to Home'}>
